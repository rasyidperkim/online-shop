        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white overflow-hidden shadow sm:rounded-lg mb-10">
                <div class="p-6 bg-white border-b border-gray-200">
                    <table class="table-auto w-full">
                        <tbody>
                            <tr>
                                <th class="border px-6 py-4 text-right w-2/12">Nama</th>
                                <td class="border px-6 py-4 w-10/12">{{ $transaction->name }}</td>
                            </tr>
            ...
            <div class="shadow overflow-auto md:overflow-scroll sm-rounded-md">
                <div class="py-4 px-5 sm:p-6 bg-white">
                    <table id="crudTable" class="overflow-auto sm:overflow-scroll">
                        <thead>
                            <tr>
                                <th>ID</th>
                                <th>Produk</th>
